                    ...
                    <div class="w-full bg-white rounded-lg sahdow-lg overflow-hidden flex flex-col md:flex-row">
                        ...
                        <div class="w-full md:w-3/5 text-left p-4 md:p-4 space-y-2">
                            ...
                            <div class="flex justify-start space-x-2">
                                ...
                                <!-- facebook -->
                                @if ($post->facebook)
                                    <a href="{{ $post->facebook }}" class="mt-2 text-indigo-800 hover:text-indigo-900">
                                ...
                                <!-- instagram -->
                                @if ($post->instagram)
                                    <a href="{{ $post->instagram }}" target="_blank" class="mt-2 text-indigo-800 hover:text-indigo-900">
                                        <svg class="w-6 h-6" aria-hidden="true" fill="currentColor" viewBox="0 0 24 24">
                                ...
                                <!-- twiter -->
                                @if ($post->twiter)
                                    <a href="{{ $post->twiter }}" target="_blank" class="mt-2 text-indigo-800 hover:text-indigo-900">
                                        <svg class="w-6 h-6" aria-hidden="true" fill="currentColor" viewBox="0 0 24 24">
                                ...
                                <!-- Github -->
                                @if ($post->github)
                                    <a href="{{ $post->github }}" target="_blank" class="mt-2 text-indigo-800 hover:text-indigo-900">
                                        <svg class="w-6 h-6" aria-hidden="true" fill="currentColor" viewBox="0 0 24 24">
