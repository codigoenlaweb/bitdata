                    ...
                    <div class="w-full bg-white rounded-lg sahdow-lg overflow-hidden flex flex-col md:flex-row">
                        ...
                        <div class="w-full md:w-3/5 text-left p-4 md:p-4 space-y-2">
                            ...
                            <div class="flex justify-start space-x-2">
                                ...
                                <!-- facebook -->
                                @if ($post->facebook)
                                    <a href="http://www.facebook.com/{{ $post->facebook }}" target="_blank" class="mt-2 text-indigo-800 hover:text-indigo-900">
                                        <svg class="w-6 h-6" aria-hidden="true" fill="currentColor" viewBox="0 0 24 24">
                                            <path fill-rule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clip-rule="evenodd"></path>
                                        </svg>
                                    </a>
                                @else
                                    <svg class="mt-2 text-gray-500 w-6 h-6" aria-hidden="true" fill="currentColor" viewBox="0 0 24 24">
                                        <path fill-rule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clip-rule="evenodd"></path>
                                    </svg>
                                @endif
                                ...
                                <!-- instagram -->
                                @if ($post->instagram)
                                    <a href="http://www.instagram.com/{{ $post->instagram }}" target="_blank" class="mt-2 text-indigo-800 hover:text-indigo-900">
                                        <svg class="w-6 h-6" aria-hidden="true" fill="currentColor" viewBox="0 0 24 24">
                                ...
                                <!-- twiter -->
                                @if ($post->twiter)
                                    <a href="http://twitter.com/{{ $post->twiter }}" target="_blank" class="mt-2 text-indigo-800 hover:text-indigo-900">
                                        <svg class="w-6 h-6" aria-hidden="true" fill="currentColor" viewBox="0 0 24 24">
                                ...
                                <!-- Github -->
                                @if ($post->github)
                                    <a href="https://github.com/{{ $post->github }}" target="_blank" class="mt-2 text-indigo-800 hover:text-indigo-900">
                                        <svg class="w-6 h-6" aria-hidden="true" fill="currentColor" viewBox="0 0 24 24">
